...
import { Heart, Coffee, Zap, Crown, X, CheckCircle } from 'lucide-react-native';
        ...
        <View style={styles.content}>
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.thankYou}>
              <Text style={styles.thankYouTitle}>СПАСИБО ЗА ПОДДЕРЖКУ! 🙏</Text>
              <Text style={styles.thankYouText}>
                Каждый донат, независимо от размера, имеет огромное значение для развития NOOW. 
                Вместе мы создаем будущее продуктивности!
              </Text>
            </View>
          </ScrollView>
        </View>
