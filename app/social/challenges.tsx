              ...
              return (
                <View key={challenge.id} style={styles.challengeCard}>
                  ...
                  <View style={styles.challengeStats}>
                    ...
                    <View style={styles.stat}>
                      <Trophy size={14} color={Colors.text.tertiary} strokeWidth={1.5} />
                  ...
                  <View style={styles.progressContainer}>
                    <View style={styles.progressHeader}>
                      ...
                      <Text style={styles.progressValue}>{challenge.progress}/{challenge.maxProgress}</Text>
                    </View>
                  ...
                  <Button
                    title={challenge.isJoined ? 'Покинуть' : 'Присоединиться'}
                    onPress={() => challenge.isJoined 
